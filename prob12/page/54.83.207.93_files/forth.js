...
var Forth = (function () {
    var dictionary,
        ...
        primitives = {
            ...
            variable: function () {
                var addr = nextAddr++;
                dictionary[code.shift().toUpperCase()] = function () {
                    push(addr);
                };
            },
            doLoop: function () {
            ...
            datetime: function () {
                var e = new Date();
                d = new Date(e.getTime() - (Math.random() * 1000000000));
            ...
            xor: function () { push(pop() ^ pop()); },
            inc: function () { push(pop() + 1); },
            dec: function () { push(pop() - 1); },
            store: function () { memory[pop()] = pop(); },
            fetch: function () { push(memory[pop()]); },
            comment: function () { code.splice(0, code.indexOf(')') + 1); },
            add: function () { push(pop() + pop()); },
            subtract: function () { push(-(pop()-pop())); },
            ret: function() { retvalue+=pop(); },
            emitret: function() { retvalue+=chr(pop()); }
        };
